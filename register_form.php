    ...
    <body>
        ...
        <div class="register">
            ...
            <form action="register.php" method="post">
                <input type="email" name="email" class="mail" placeholder="ADRESSE MAIL" required>
                <input type="password" name="password" class="mdp" placeholder="MOT DE PASSE"  required >
                <input type="password" name="conf_password" class="mdp" placeholder="CONFIRMER LE MOT DE PASSE" required />
