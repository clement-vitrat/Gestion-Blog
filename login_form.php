    ...
    <body>
        ...
        <div class="login">
            ...
            <form action="login.php" method="post">
                <p><input type="email" class="mail" name="email" placeholder="ADRESSE MAIL" required></p>
                <p><input type="password" class="mdp" name="password" placeholder="MOT DE PASSE" required></p>
