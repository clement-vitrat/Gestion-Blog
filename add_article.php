<?php
    ...
    $rqt = "INSERT INTO article(titre, corps, created_at, id_utilisateur) VALUES (:titre, :corps, :create_at, :id_utilisateur);"; 
    ...
    try {
        ...
        $requete_preparee->bindParam(':create_at', date('Y-m-d'));
